...
def write_regime_tex(path):
    lines = [r"\begin{table}[p]", r"\centering", r"\footnotesize",
             r"\caption{Regime map over the eleven \textbf{v1} benchmarks. The regime is decided "
             r"by three timescales relative to the run --- whether the conditional ensemble at "
             r"fixed $\xi$ has equilibrated at all, how long a relevant state takes to be "
             ...
             r"establishment evidence are therefore stated independently of the mFR column. The "
             r"first of the three is Gate 0, which postdates these runs and was backfilled onto "
             r"them; see \cref{sec:validity}. The four v2 systems are tabulated separately in "
             r"\cref{tab:regime_map_v2}. "
