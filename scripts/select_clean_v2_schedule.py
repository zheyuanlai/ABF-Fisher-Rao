...
def parse_args(argv=None):
    ...
    p.add_argument("--ignore-screen", action="store_true",
                   help="Rank even when no schedule passed the screen.  Use only "
                        "to document what the best cell was in a negative pilot; "
                        "it does NOT authorise a confirmation run.")
