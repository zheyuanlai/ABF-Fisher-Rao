...
This report asks how FR changes ABF across \emph{five} controlled systems, not
...
(\cref{sec:abf,sec:fr,sec:alkane_force}); (ii) five matched-seed production studies
